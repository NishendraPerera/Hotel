...
<img src="{{asset('assets/logo.jpg')}}" alt="logo" style="max-width: 60%;">
</div>

        <input id="tab-1" type="radio" name="tab" class="sign-in"  checked><label for="tab-1" class="tab">Manager Login</label>
