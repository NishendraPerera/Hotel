<ul class="list-unstyled">
    ...
    <li class="{{active_menu([route('backend.admin.reservation'),route('backend.admin.reservation.create')],'active')}}"><a href="{{route('backend.admin.reservation')}}"><i class="fa fa-fw fa-hotel"></i> Reservation </a></li>
    ...
    <li>
        ...
        <ul id="Hotel_configure" class="list-unstyled collapse {{active_menu([
            ...
            <li class="{{active_menu([route('backend.admin.food'),route('backend.admin.food.create')],'active',['backend.admin.food.edit'])}}"> <a href="{{route('backend.admin.food')}}"> <i class="fa fa-circle-o"></i> Food & Beverage</a></li>
    ...
    @if(auth()->guard('admin')->user()->can_access('admin'))
        <li class="{{active_menu([route('backend.admin.user'),route('backend.admin.user.create')],'active',['backend.admin.user.view'])}}"><a href="{{route('backend.admin.user')}}"><i class="fa fa-fw fa-users"></i> Manage Users </a></li>
        <li>
        <li class="{{active_menu([route('backend.admin.staff'),route('backend.admin.staff.create')],'active',['backend.admin.staff.view'])}}"><a href="{{route('backend.admin.staff')}}"><i class="fa fa-fw fa-user-plus"></i> Manage Staffs </a></li>
    @endif
        <li>
            <a href="#Reports" data-toggle="collapse">
                <i class="fa fa-fw fa-line-chart"></i> Reports
            </a>
            <ul id="Reports" class="list-unstyled collapse {{active_menu([
                route('admin.reports.reservation'), route('admin.reports.food'), route('admin.reports.sale'), route('admin.reports.taxi'), route('admin.reports.daily'), route('admin.reports.service'), route('admin.reports.payment')
                ],'show')}}">
                <li class="{{active_menu([route('admin.reports.reservation')],'active')}}"> <a href="{{route('admin.reports.reservation')}}"> <i class="fa fa-circle-o"></i> Reservation Report</a></li>

                <li class="{{active_menu([route('admin.reports.daily')],'active')}}"> <a href="{{route('admin.reports.daily')}}"> <i class="fa fa-circle-o"></i> Daily Report</a></li>

                <li class="{{active_menu([route('admin.reports.food')],'active')}}"> <a href="{{route('admin.reports.food')}}"> <i class="fa fa-circle-o"></i> Food/ Beverages Report</a></li>

                <li class="{{active_menu([route('admin.reports.service')],'active')}}"> <a href="{{route('admin.reports.service')}}"> <i class="fa fa-circle-o"></i> Paid Services Report</a></li>

                <li class="{{active_menu([route('admin.reports.sale')],'active')}}"> <a href="{{route('admin.reports.sale')}}"> <i class="fa fa-circle-o"></i> Sales Report</a></li>

                <li class="{{active_menu([route('admin.reports.taxi')],'active')}}"> <a href="{{route('admin.reports.taxi')}}"> <i class="fa fa-circle-o"></i> Taxi Report</a></li>

                <li class="{{active_menu([route('admin.reports.payment')],'active')}}"> <a href="{{route('admin.reports.payment')}}"> <i class="fa fa-circle-o"></i> Payments Report</a></li>
            </ul>
        </li>
        {{-- <li>
