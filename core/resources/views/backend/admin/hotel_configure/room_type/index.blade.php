            ...
            <div class="card-body p-0">
                <table class="table table-sm table-condensed mb-0">
                    ...
                    <tr>
                        ...
                        <td>{{$roomType->hours}}</td>
                        <td>{{general_setting()->cur_sym}}{{ number_format($roomType->base_price, 0, '.', ',' )}}</td>
                                ...
                                <form class="" action="" method="post" id="spaicel_form">@csrf
                                    ...
                                    <div class="form-row justify-content-center">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control " id="start_time"  name="start_time" value="{{date('Y/m/d')}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label><strong>End Date</strong></label>
                                            <input type="text" class="form-control " id="end_time"  name="end_time" value="{{date('Y/m/d')}}">
                                        </div>
                                    </div>
                                    <hr/>
