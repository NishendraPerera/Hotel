            ...
            <div class="card-body">
                <form action="{{route('backend.admin.room_type.update',$roomType->id)}}" method="post" enctype="multipart/form-data">@csrf
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-md-4">
                            <label><strong>Hours</strong> <small class="text-danger">*</small></label>
                            <input type="text" class="form-control form-control-lg" name="hours" placeholder="Hours" value="{{$roomType->hours}}" required>
                        </div>
                    </div>
                    {{-- <div class="form-row justify-content-center">
