            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    var table = $('.table').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: {url : "{{ route('admin.reports.sale_list') }}"
                        ...
                        columns: [
                            ...
                            {data: 'room_charges', name: 'room_charges', className: "dt-body-right"},
                            {data: 'food_charges', name: 'food_charges', className: "dt-body-right"},
                            {data: 'service_charges', name: 'service_charges', className: "dt-body-right"},
