            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    var table = $('.table').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: {url : "{{ route('admin.reports.food_list') }}"
                        , data : function(d) { d.starting = document.getElementById("start").value; d.ending = document.getElementById("end").value; d.salesMonth = document.getElementById("salesMonth").value; d.food = document.getElementById("food").value; 
                        d.staff = document.getElementById("staff").value; }
                        , dataSrc : function(json){ $('#from').html("<b>From: </b>"+json.from); $('#to').html("<b>To: </b>"+json.to); $('#tableFood').html("<b>Food/ Beverage: </b>"+json.food); $('#tableStaff').html("<b>Staff: </b>"+json.staff); $('#tableTotal').html("<b>Total: </b>"+json.total); return json.data; } 
                        },
                        "order": [[ 1, "desc" ]],
                        columns: [
