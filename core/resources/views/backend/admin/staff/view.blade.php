                    ...
                    <div class="tile">
                        <div class="card">
                            <div class="card-body text-center bg-tsk-o-1">
                                ...
                                <dl class="row">
                                    <dt class="col-md-6 text-md-right">NIC No : </dt>
                                    <dd class="col-md-6 text-md-left">{{$staff->nic}}</dd>
                                </dl>
                        ...
                        <div class="tile-body">
                            ...
                            <form action="{{route('backend.admin.staff.update',$staff->id)}}" method="post" enctype="multipart/form-data">@csrf
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label><strong>NIC No</strong> <small class="text-danger">*</small> </label>
                                        <input type="text" class="form-control form-control-lg" name="nic" placeholder="NIC No" value="{{$staff->nic}}">
                                    </div>
                                </div>
                                <div class="form-row justify-content-center">
                                    ...
                                    <div class="form-group col-md-8">
                                        ...
                                        <textarea  class="form-control form-control-lg" rows="4" name="address">{{$staff->address}}</textarea>
