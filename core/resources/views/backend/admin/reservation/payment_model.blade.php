                        ...
                        <form class="" action="{{route('backend.admin.reservation.payment',$data->id)}}" method="post" enctype="multipart/form-data">@csrf
                            ...
                            <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input class="form-control" name="date" readonly value="{{date('Y-m-d H:i')}}">
                                </div>
                            </div>
                            <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
                            ...
                            <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="number" class="form-control" name="amount" value="" placeholder="0.00" min="1" max="{{ $reservation->payable()-$reservation->payment->sum('amount') }}" required>
                                </div>
                            </div>
                            <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
