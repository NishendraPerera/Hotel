                    ...
                    <div class=" mb-3">
                        <div class="form-row justify-content-center " v-show="next === 1">
                            <div class="form-group col-md-4">
                                ...
                                <div id="app">
                                    <v-select label="text" id="guest" :class="['form-control',errors.has('guest')?'is-invalid':'']" @change="errors.clear('guest')" @search="fetchOptions" name="guest" v-model="selected" :value="selected" :options="options" v-on:click="changed"></v-select>
                                </div>
        ...
        var app = new Vue({
            ...
            watch:{
                'form.guest':function (val) {
                    let $this = this;
                    //$this.form.guest_text =val===''?'': $this.selected.text;
                },
            ...
            methods:{
                ...
                search: _.debounce((loading, search, vm) => {
                    ...
                    fetch("{{ route('backend.admin.guest_select') }}",{
                        headers: {
                        ...
                        method: "POST",
                        body: JSON.stringify({
                            _token: CSRF_TOKEN, searchTerm: search
                        })
                    })
                    .then(res => {
                ...
                createData:function (e) {
                    ...
                    this.form.guest = this.selected.id;
                    this.form.guest_text = this.selected.text;
