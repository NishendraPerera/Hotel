    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-bell"></i>  Service</h5>
                        ...
                        <form class="" action="{{route('backend.admin.reservation.add_service',$data->id)}}" method="post" >@csrf
                            ...
                            <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input class="form-control" name="date" id="service_date" readonly value="{{date('Y-m-d H:i')}}">
                                </div>
                            </div>
                            <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
                            ...
                            {{-- <div class="form-row justify-content-center">
                                <div class="form-group col-sm-12">
                                    <label><strong>Paid Service</strong> <small class="text-danger">*</small></label><br>
                                    <select class="select2 service-list-ajax form-control form-control-lg"></select>
                                </div>
                            </div> --}}
