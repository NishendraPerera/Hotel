                                            ...
                                            <form action="{{route('backend.admin.guests.update',$guest->id)}}" method="post" enctype="multipart/form-data">@csrf
                                                ...
                                                <div class="form-row justify-content-center">
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" name="dob" id="dob" value="@if(!is_null($guest->dob)){{date('Y/m/d',strtotime($guest->dob))}} @endif">
                                                    </div>
                                                    <div class="form-group col-md-8">
                                ...
                                <table class="table table-sm table-condensed mb-0">
                                    ...
                                    @foreach($reservations as $key=>$reservation)
                                        <tr>
                                            ...
                                            <td>{{ date('Y-m-d H:i', strtotime($reservation->check_in)) }}</td>
                                            <td>{{ date('Y-m-d H:i', strtotime($reservation->check_out)) }}</td>
