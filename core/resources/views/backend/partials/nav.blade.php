<nav class="navbar navbar-expand navbar-dark bg-tsk d-print-none" style="background-color: #343a40 !important;">
    ...
    <div class="navbar-collapse collapse">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a href="#" id="dd_user" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>&nbsp; {{ ucfirst(auth_user()->username)}}</a>
