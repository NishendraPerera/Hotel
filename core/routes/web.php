...
// Route::get('/', 'Backend\Auth\LoginController@showLoginForm')->name('home');
...
Route::group(['middleware'=>'guest'],function(){
    ...
    Route::group(['prefix'=>'/admin','middleware' => 'auth:admin'],function () {
        ...
        Route::group(['middleware' => 'permission:admin'],function () {
            ...
            Route::get('food', 'Backend\Admin\HotelConfigure\FoodController@index')->name('backend.admin.food');
            Route::get('food/list', 'Backend\Admin\HotelConfigure\FoodController@food_list')->name('backend.admin.food_lists');
            Route::get('food/create', 'Backend\Admin\HotelConfigure\FoodController@create')->name('backend.admin.food.create');
            Route::post('food/store', 'Backend\Admin\HotelConfigure\FoodController@store')->name('backend.admin.food.store');
            Route::get('food/{id}/edit', 'Backend\Admin\HotelConfigure\FoodController@edit')->name('backend.admin.food.edit');
            Route::post('food/{id}/update', 'Backend\Admin\HotelConfigure\FoodController@update')->name('backend.admin.food.update');
            Route::post('food/{id}/delete', 'Backend\Admin\HotelConfigure\FoodController@delete')->name('backend.admin.food.delete');
            ...
            ///////////////////////////////// Manage User///////////////////////
            Route::get('user', 'Backend\Admin\UserController@index')->name('backend.admin.user');
            Route::get('user/list', 'Backend\Admin\UserController@user_list')->name('backend.admin.user_lists');
            Route::get('user/create', 'Backend\Admin\UserController@create')->name('backend.admin.user.create');
            Route::post('user/store', 'Backend\Admin\UserController@store')->name('backend.admin.user.store');
            Route::get('user/{id}/view', 'Backend\Admin\UserController@view')->name('backend.admin.user.view');
            Route::post('user/{id}/update', 'Backend\Admin\UserController@update')->name('backend.admin.user.update');

            ///////////////////////////////// Manage Staff///////////////////////
            Route::get('staff', 'Backend\Admin\StaffController@index')->name('backend.admin.staff');
            Route::get('staff/list', 'Backend\Admin\StaffController@staff_list')->name('backend.admin.staff_lists');
        ...
        Route::post('guests/select', 'Backend\Admin\GuestController@guest_select')->name('backend.admin.guest_select');
        Route::get('guests/list', 'Backend\Admin\GuestController@guest_list')->name('backend.admin.guest_lists');
        ...
        Route::get('reservation/list', 'Backend\Admin\ReservationController@reservation_list')->name('backend.admin.reservation.list');
        ...
        Route::post('reservation/{id}/add_food', 'Backend\Admin\ReservationController@addFood')->name('backend.admin.reservation.add_food');
        ...
        Route::post('reservation/{id}/remove_food', 'Backend\Admin\ReservationController@removeFood')->name('backend.admin.reservation.remove_food');
        Route::post('reservation/{id}/remove_payment', 'Backend\Admin\ReservationController@removePayment')->name('backend.admin.reservation.remove_payment');
        ...
        /***************** Reports ********************/
        Route::get('/reports/reservation','Backend\Admin\ReportController@reservation')->name('admin.reports.reservation');
        Route::get('/reports/reservation/list','Backend\Admin\ReportController@reservation_list')->name('admin.reports.reservation_list');

        Route::get('/reports/food','Backend\Admin\ReportController@food')->name('admin.reports.food');
        Route::get('/reports/food/list','Backend\Admin\ReportController@food_list')->name('admin.reports.food_list');

        Route::get('/reports/service','Backend\Admin\ReportController@service')->name('admin.reports.service');
        Route::get('/reports/service/list','Backend\Admin\ReportController@service_list')->name('admin.reports.service_list');

        Route::get('/reports/payment','Backend\Admin\ReportController@payment')->name('admin.reports.payment');
        Route::get('/reports/payment/list','Backend\Admin\ReportController@payment_list')->name('admin.reports.payment_list');

        Route::get('/reports/taxi','Backend\Admin\ReportController@taxi')->name('admin.reports.taxi');
        Route::get('/reports/taxi/list','Backend\Admin\ReportController@taxi_list')->name('admin.reports.taxi_list');

        Route::get('/reports/sale','Backend\Admin\ReportController@sale')->name('admin.reports.sale');
        Route::get('/reports/sale/list','Backend\Admin\ReportController@sale_list')->name('admin.reports.sale_list');

        Route::get('/reports/daily','Backend\Admin\ReportController@daily')->name('admin.reports.daily');
        Route::get('/reports/daily/list','Backend\Admin\ReportController@daily_list')->name('admin.reports.daily_list');

        /***************** Others ********************/

        Route::get('/reservation/new/get_room_type_details','Backend\Admin\ReservationNewController@get_room_type_details')->name('admin.reservation.new.get_room_type_details');
        Route::get('/reservation/new/get_available_dates','Backend\Admin\ReservationNewController@get_available_dates')->name('admin.reservation.new.get_available_dates');
        Route::post('/reservation/new/store','Backend\Admin\ReservationNewController@store')->name('admin.reservation.new.store');

        Route::post('/reservation/new/room_type_change/{id}','Backend\Admin\ReservationNewController@room_type_change')->name('admin.reservation.new.room_type_change');
        Route::post('/reservation/new/taxi/{id}','Backend\Admin\ReservationNewController@taxi')->name('admin.reservation.new.taxi');
        Route::post('/reservation/new/manual_checkout/{id}','Backend\Admin\ReservationNewController@manual_checkout')->name('admin.reservation.new.manual_checkout');
        Route::post('/reservation/new/discount/{id}','Backend\Admin\ReservationNewController@discount')->name('admin.reservation.new.discount');

        Route::post('/reservation/new/food_select','Backend\Admin\ReservationNewController@food_select')->name('admin.reservation.new.food_select');
        Route::post('/reservation/new/service_select','Backend\Admin\ReservationNewController@service_select')->name('admin.reservation.new.service_select');

        Route::post('reservation/{id}/remove_taxi', 'Backend\Admin\ReservationNewController@removeTaxi')->name('backend.admin.reservation.new.remove_taxi');
        Route::post('reservation/{id}/remove_discount', 'Backend\Admin\ReservationNewController@removeDiscount')->name('backend.admin.reservation.new.remove_discount');
